...
<div id="modalCadastrar" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
  ...
  <div class="modal-header">
    ...
    <h3 id="myModalLabel">MAP OS  - Registrar Datos de la Empresa</h3>
  </div>
  <div class="modal-body">
                    ...
                    <div class="control-group">
                        <label for="cnpj" class="control-label"><span class="required">NTR*</span></label>
                        <div class="controls">
                            <input class="" type="text" name="cnpj" value=""  />
                        </div>
                    </div>
                    <div class="control-group">
                        <label for="descricao" class="control-label"><span class="required">NIF*</span></label>
                        <div class="controls">
                ...
                <table class="table table-bordered">
                    <tbody>
                        <tr>
                            ...
                            <td> <span style="font-size: 20px; "> <?php echo $dados[0]->nome; ?> </span> </br><span>NTR/NIF: <?php echo $dados[0]->cnpj; ?> <br> <?php echo $dados[0]->rua.', Nº: '.$dados[0]->numero.' - '.$dados[0]->bairro.' <br> '.$dados[0]->cidade.' - '.$dados[0]->uf; ?> </span> </br> <span> E-mail: <?php echo $dados[0]->email.' <br> Tel.: '.$dados[0]->telefone; ?></span></td>
                        </tr>
                    </tbody>
                </table>
...
<div id="modalAlterar" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
  ...
  <div class="modal-header">
    <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
    <h3 id="">MAP OS  - Editar Datos de la Empresa</h3>
  </div>
  <div class="modal-body">
...
<div id="modalLogo" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
  ...
  <div class="modal-header">
    <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
    <h3 id="">MAP OS  - Modificar Dirección</h3>
  </div>
  <div class="modal-body">
