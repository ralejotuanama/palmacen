...
<html lang="es">
  ...
  <body>
    ...
    <!--Header-part-->
    <div id="header">
      <h1><a href="dashboard.html">MAP OS </a></h1>
    </div>
    <!--close-Header-part--> 
    ...
    <div id="user-nav" class="navbar navbar-inverse">
      <ul class="nav">
        ...
        <li class=""><a title="" href="<?php echo base_url()?>index.php/conecte/sair"><i class="icon icon-share-alt"></i> <span class="text"> Cerrar sesión</span></a></li>
    ...
    <div id="content">
      <div id="content-header">
        <div id="breadcrumb"><a href="#" title="" class="tip-bottom"> <i class="icon-home"></i> Panel</a></div>
      </div>
