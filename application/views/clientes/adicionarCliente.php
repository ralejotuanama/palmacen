        ...
        <div class="widget-box">
            ...
            <div class="widget-content nopadding">
                <?php if ($custom_error != '') {
                    ...
                    <div class="control-group">
                        <label for="documento" class="control-label">RUC<span class="required">*</span></label>
                        <div class="controls">
                    ...
                    <div class="control-group" class="control-label" style="display:none;">
